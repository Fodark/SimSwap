...
class Face_detect_crop:
    ...
    def get(self, img, crop_size, anony_mode, max_num=0):
        ...
        highest_conf, highest_conf_kps = (
            bboxes[max_conf_idx : max_conf_idx + 1],
            kpss[max_conf_idx : max_conf_idx + 1],
        )
        ...
        if anony_mode == "Anonymise you":
            bboxes, kps = highest_conf, highest_conf_kps  # bboxes[0:1], kpss[0:1]
        elif bboxes.shape[0] > 1:
            bboxes, kps = others, others_kp  # bboxes[1:], kpss[1:]
        else:
            return None
