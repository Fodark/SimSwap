...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        pic_b_path = opt.pic_b_path
        for f in tqdm(os.listdir(pic_b_path)):
            pic_b = os.path.join(pic_b_path, f)
            img_b_whole = cv2.imread(pic_b)

            try:
                img_b_align_crop_list, b_mat_list = app.get(img_b_whole, crop_size)
            except:
                print(f"Error with image {f}")
                continue
            # detect_results = None
            swap_result_list = []
            ...
            reverse2wholeimage(
                ...
                img_b_whole,
                logoclass,
                os.path.join(opt.output_path, f),
                opt.no_simswaplogo,
                pasring_model=net,
            ...
            # os.rename('/media/dvl1/SSD_DATA/bigraph-dataset/rebuttal/simswap/result_whole_swapsingle.jpg')
